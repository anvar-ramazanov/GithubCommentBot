...
namespace GithubCommentBot.Test
{
    public class HookParserTests
    {
        [Fact]
        public void ParsePrWebHookTest()
        {
            var json = @"{
  'action': 'submitted',
  'review': {
  ...
  'sender': {
    ...
    'site_admin': false
            ...
            var parser = new HookParserImpl();

            var result = parser.ParsePrWebHook(json);
        ...
        [Fact]
        public void ParsePrCommentWebHook()
        {
            var json = @"{
  'action': 'created',
  'comment': {
  ...
  'sender': {
    ...
    'site_admin': false
            ...
            var result = parser.ParsePrCommentWebHook(json);
